    ...
    $.widget("jtsage.datebox", {
        ...
        _stdBtn: {
            cancel: function() {
                ...
                return $("<a href='#' role='button' class='" + o.btnCls + o.themeCancelButton + "'><span class='" + o.icnCls + "times'></span> " + w.__("cancelButton") + "</a>").on(o.clickEventAlt, function(e) {
                    e.preventDefault();
                    w._t({
                        method: "close",
                        closeCancel: true
            ...
            today: function() {
                var w = this, o = this.options;
                return $("<a href='#' role='button' class='" + o.btnCls + o.themeTodayButton + "'><span class='" + o.icnCls + "step-forward'></span> " + w.__("todayButtonLabel") + "</a>").on(o.clickEventAlt, function(e) {
                    e.preventDefault();
            ...
            tomorrow: function() {
                var w = this, o = this.options;
                return $("<a href='#' role='button' class='" + o.btnCls + o.themeTomorrowButton + "'><span class='" + o.icnCls + "step-forward'></span> " + w.__("tomorrowButtonLabel") + "</a>").on(o.clickEventAlt, function(e) {
                    e.preventDefault();
