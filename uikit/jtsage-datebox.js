...
(function($) {
    $.widget("jtsage.datebox", {
        ...
        style_inBtn: function(icon, title) {
            this.d.wrap.prepend("<a href='#' title='" + title + "' class='dbOpenButton uk-form-icon uk-form-icon-flip'>" + this.icons.getIcon(icon) + "</a>");
            return "";
        },
        ...
        style_mainHead: function(text, themeBar, themeButton) {
            return "<nav class='uk-navbar-container' uk-navbar>" + "<div class='uk-navbar-left'>" + '<ul class="uk-navbar-nav"><li class="uk-active">' + '<div class="uk-navbar-item uk-logo">' + text + "</div></li></ul>" + "</div><div class='uk-navbar-right'>" + "<ul class=\"uk-navbar-nav\"><li><a href='#' class='dbCloser'>" + this.icons.getIcon(themeButton[0]) + "</a></li></ul>" + "</div></div>";
        },
