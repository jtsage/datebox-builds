...
(function($) {
    $.widget("jtsage.datebox", {
        ...
        style_inBtn: function(icon, title) {
            this.d.wrap.prepend("<a href='#' title='" + title + "' class='dbOpenButton uk-form-icon uk-form-icon-flip'>" + this.icons.getIcon.call(this, icon) + "</a>");
            return "";
        },
        ...
        style_inHide: function() {
            var w = this, last = w.d.wrap, exitLoop = 0, hideMe = w.d.wrap;
            for (;;) {
                exitLoop++;
        ...
        style_mainHead: function(text, themeBar, themeButton) {
            return "<nav class='uk-navbar-container' uk-navbar>" + "<div class='uk-navbar-left'>" + '<ul class="uk-navbar-nav"><li class="uk-active">' + '<div class="uk-navbar-item uk-logo">' + text + "</div></li></ul>" + "</div><div class='uk-navbar-right'>" + "<ul class=\"uk-navbar-nav\"><li><a href='#' class='dbCloser'>" + this.icons.getIcon.call(this, themeButton[0]) + "</a></li></ul>" + "</div></div>";
        },
        style_subHead: function(text) {
            return $("<div class='uk-text-center uk-margin-top dbHeader'><h5>" + text + "</h5></div>");
        },
        style_pnHead: function(txt, prevBtn, nextBtn, prevCtl, nextCtl) {
            var returnVal = $("<div class='uk-grid uk-grid-collapse uk-margin-top'>");
            $("<div class='uk-text-center uk-width-1-6'>" + this.style_btn([ prevBtn[0], prevBtn[1] + " mx-2 " + prevCtl ]) + "</div>").appendTo(returnVal);
            $("<div class='uk-width-expand uk-text-center'><h4>" + txt + "</h4></div>").appendTo(returnVal);
            $("<div class='uk-text-center uk-width-1-6'>" + this.style_btn([ nextBtn[0], nextBtn[1] + " mx-2 " + nextCtl ]) + "</div>").appendTo(returnVal);
            return returnVal;
        },
        ...
        style_calGrid: function() {
            return $("<div class='uk-width-1-1 uk-margin'><table class='dbCalGrid uk-width-1-1'></table></div>");
        },
        style_calRow: function() {
            return $("<tr>");
        },
        style_calBtn: function(data, totalElements) {
            var styles_TD = [ "width : " + 100 / totalElements + "%" ], class_TD = [ "uk-margin-remove", "uk-padding-remove", "uk-text-center" ], class_A = [ "dbEvent", "uk-width-1-1", "uk-button", "uk-button-small", "uk-padding-remove", "uk-button-" + data.theme, data.bad ? " disabled" : "" ], disable = data.bad ? "disabled='disabled'" : "";
        ...
        style_calTxt: function(text, header, totalElements) {
            var styles_TD = "width : " + 100 / totalElements + "%", class_TD = [ "uk-margin-remove", "uk-padding-remove", "uk-text-center", header ? "uk-text-bold" : "" ];
        ...
        style_dboxCtrl: function(prevBtn, nextBtn, mainCls, label) {
            ...
            returnVal += this.style_btn([ nextBtn[0], nextBtn[1] + " dbBoxNext uk-padding-remove uk-width-1-1" ]);
            if (label !== null) {
                returnVal += "<div class='uk-text-center' " + "style='height:auto'>" + label + "</div>";
            }
            returnVal += "<input type='text' ";
            returnVal += "class='uk-input uk-padding-remove uk-text-center'>";
            returnVal += this.style_btn([ prevBtn[0], prevBtn[1] + " dbBoxPrev uk-padding-remove uk-width-1-1" ]);
            returnVal += "</div>";
            return $(returnVal);
        },
        ...
        style_slideBtn: function(data) {
            var styles_TD = "width: " + 100 / 8 + "%", class_TD = [ "uk-margin-remove", "uk-padding-remove", "uk-text-center" ], class_A = [ "dbEventS", "uk-button", "uk-width-1-1", "uk-padding-remove", "uk-button-" + data.theme, data.bad ? "disabled" : "" ], disable = data.bad ? "disabled='disabled'" : "";
            return $("<td class='" + class_TD.join(" ") + "' style='" + styles_TD + "'>" + "<a href='#' class='" + class_A.join(" ") + "' " + disable + ">" + "<span class='uk-text-small'>" + this.__("daysOfWeekShort")[data.dateObj.getDay()] + "</span>" + "<br>" + data.dateObj.getDate() + "</a></td>");
        },
        style_slideCtrl: function(eventCls, theme) {
            var styles_TD = "width: " + 100 / 8 / 2 + "%", class_TD = [ "uk-margin-remove", "uk-padding-remove", "uk-text-center" ], class_A = [ "uk-width-1-1", "uk-padding-remove", "uk-button", "uk-button-" + theme[1], eventCls ];
        ...
        style_fboxCtr: function(size) {
            return $("<div class='uk-margin' style='height: " + size + "; overflow: hidden'>");
        },
        style_fboxDurLbls: function() {
            return $("<div class='' style='margin-bottom: -8px;'>");
        },
        style_fboxDurLbl: function(text, items) {
            return $("<div class='uk-text-center uk-display-inline-block' " + "style='width: " + 100 / items + "%'>" + text + "</div>");
        },
        style_fboxRollCtr: function(total) {
            var style = [ "width: " + 100 / total + "%", "float: left" ];
        ...
        style_fboxRollCld: function(text, cls) {
            return $("<li style='margin-top:0; margin-bottom:0; padding:4px 0;' " + "class='uk-text-center uk-background-" + cls + "'>" + text + "</li>");
        },
        style_fboxLens: function() {
            return $("<div class='uk-width-1-1 uk-box-shadow-small' " + "style='height:40px; border: 1px solid rgba(0,0,0,.2);'>");
        },
